...
namespace Huan.DbSwitcher.Store
{
    public static class DbStoreServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddDbStore(
            ...
            )
        {
            ...
            services.TryAddSingleton<IRelationalDatabaseProcessorDbStore, DefaultRelationalDatabaseProcessorDbStore>();
            ...
            string providerName, Func<Type, DatabaseType, string, IRelationalDatabaseProcessor> createFunc = null)
        {
            ...
            var storage = serviceProvider.GetRequiredService<IRelationalDatabaseProcessorDbStore>();
